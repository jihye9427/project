...
public class WebConfig implements WebMvcConfigurer {
    ...
    /**
     * [수정] 정적 리소스는 특정 경로만 지정하여 Controller 경로와 충돌을 막습니다.
     */
    @Override
    ...
    /**
     * [추가] 로직이 없는 단순 페이지에 대해 Controller 없이 URL과 뷰(HTML)를 직접 매핑합니다.
     */
    @Override
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/buyer/signup").setViewName("buyer/buyer_signup"); // join -> signup으로 통일
        ...
        registry.addViewController("/seller/signup").setViewName("seller/seller_signup"); // join -> signup으로 통일
